...
interface LandingTrialProps {
  onViewDemo: () => void;
}

const STAR_COUNT = 5;

export const LandingTrial = ({ onViewDemo }: LandingTrialProps) => {
  ...
  return (
    <section className="relative bg-white py-14 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <div className="grid items-center grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-12">
            <div>
              ...
              <h2 className="mt-3 text-2xl sm:text-3xl lg:text-[2.1rem] font-bold text-[#1a1a2e] tracking-tight leading-snug max-w-md">
                {t("videoTitle")}
              </h2>
              ...
              <div className="mt-6 flex flex-col items-start gap-2">
                <ViewDemoButton
                  onClick={onViewDemo}
                  className="!px-7 !py-3.5 text-base shadow-sm"
                />
                <p className="text-sm text-slate-500">{t("freeTrial")}</p>
              </div>
            ...
            <div className="relative w-full rounded-2xl bg-white p-2 shadow-md ring-1 ring-slate-200/80 sm:rounded-3xl sm:p-3">
              <div className="relative aspect-video overflow-hidden rounded-xl sm:rounded-2xl bg-slate-100">
                <iframe
        ...
        <Reveal delay={120}>
          <div className="mt-12 sm:mt-14 border-t border-slate-100 pt-8">
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12 opacity-80">
              <AwsBrandMark className="h-9 w-auto text-slate-700 sm:h-10" />
              <GoogleBrandMark className="h-9 w-auto sm:h-10" />
              <Image
