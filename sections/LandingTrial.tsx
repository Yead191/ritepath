...
export const LandingTrial = ({ onViewDemo }: LandingHeroProps) => {
  ...
  const brandLogos = (
    <>
      <AwsBrandMark className="h-10 w-auto shrink-0 text-slate-800 sm:h-12" />
      <GoogleBrandMark className="h-10 w-auto shrink-0 sm:h-12" />
      <Image
  ...
  return (
    <section className="relative bg-white pt-4 pb-6 sm:pb-8 lg:pb-10">
      {/* Brand logo marquee — flush under hero, above trial card */}
      <div className="relative overflow-hidden  bg-white py-5 sm:py-6 ">
        <div className="flex w-max animate-marquee items-center gap-12 sm:gap-16 lg:gap-20 px-6">
          <div className="flex items-center gap-12 sm:gap-16 lg:gap-20">
            {brandLogos}
          </div>
          <div className="flex items-center gap-12 sm:gap-16 lg:gap-20" aria-hidden="true">
            {brandLogos}
          </div>
        </div>
      </div>

      <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mt-6 sm:mt-8 lg:mt-10">
